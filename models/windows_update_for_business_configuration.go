...
func (m *WindowsUpdateForBusinessConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsUpdateForBusinessConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
