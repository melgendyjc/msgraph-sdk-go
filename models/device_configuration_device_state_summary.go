...
func (m *DeviceConfigurationDeviceStateSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationDeviceStateSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
