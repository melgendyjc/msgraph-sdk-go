...
func (m *UnifiedRoleManagementPolicyRule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRoleManagementPolicyRule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
