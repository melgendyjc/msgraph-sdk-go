...
func (m *DeviceConfigurationDeviceOverview) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationDeviceOverview) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
