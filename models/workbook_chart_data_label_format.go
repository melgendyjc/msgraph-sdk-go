...
func (m *WorkbookChartDataLabelFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookChartDataLabelFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
