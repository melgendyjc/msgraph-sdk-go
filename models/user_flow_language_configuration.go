...
func (m *UserFlowLanguageConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserFlowLanguageConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
