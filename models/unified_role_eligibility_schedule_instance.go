...
func (m *UnifiedRoleEligibilityScheduleInstance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRoleEligibilityScheduleInstance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
