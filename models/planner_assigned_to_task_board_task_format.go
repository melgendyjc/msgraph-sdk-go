...
func (m *PlannerAssignedToTaskBoardTaskFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PlannerAssignedToTaskBoardTaskFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
