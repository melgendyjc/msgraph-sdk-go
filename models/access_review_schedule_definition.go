...
func (m *AccessReviewScheduleDefinition) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewScheduleDefinition) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
