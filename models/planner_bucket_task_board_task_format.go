...
func (m *PlannerBucketTaskBoardTaskFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PlannerBucketTaskBoardTaskFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
