...
func (m *OrganizationalBrandingProperties) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *OrganizationalBrandingProperties) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
